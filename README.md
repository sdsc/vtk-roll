...
of the vtk-roll.  To avoid cluttering the cluster frontend with unused
software, the vtk-roll is configured to install only on compute and
login nodes. To force installation on your frontend, run this command after
adding the vtk-roll to your distro

```shell
% rocks run roll vtk host=NAME | bash
```
